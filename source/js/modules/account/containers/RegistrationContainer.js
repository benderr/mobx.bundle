					...
					<ContentPopupService closeName="Закрыть" ref={p => this.agreementPopup = p}>
						...
						<div>
							<p>В&nbsp;целях регистрации на&nbsp;сайте ООО &laquo;Аванпост&raquo;, расположенного
								...
								в&nbsp;целях заключения
								Лицензионного договора на&nbsp;право использование программы для ЭВМ &laquo;
								Автоматизированное
								рабочее
								место кассира МодульКасса&raquo;, Клиент/Уполномоченный
							...
							<p>2.2. Выражаю согласие на&nbsp;передачу ООО &laquo;Аванпост&raquo; своих Персональных
								...
								целей, установленных Лицензионным договором на&nbsp;право использование программы для
								ЭВМ
								&laquo;Автоматизированное рабочее место кассира МодульКасса&raquo; (далее&nbsp;&mdash;
								Лицензионный договор), а
								также в&nbsp;целях использования личного кабинета Клиента на&nbsp;сайте ООО &laquo;
								Аванпост&raquo;
								www.modulkassa.ru и&nbsp;получения Клиентом услуг и&nbsp;сервисов
								посредством личного кабинета Клиента, третьим лицам (в&nbsp;том числе, Акционерному
								обществу
								Коммерческий Банк &laquo;Модульбанк&raquo;, в&nbsp;случаях, когда такая передача
								требуется для достижения
								целей Лицензионного договора), в&nbsp;частности, при привлечении ООО &laquo;
								Аванпост&raquo; третьих лиц в
