					...
					<ContentPopupService closeName="Назад" ref={p => this.agreementPopup = p}>
						...
						<div style={{textAlign: 'justify'}}>
							...
							<p>2.4. Передавая свои Персональные данные в&nbsp;ООО &laquo;Аванпост&raquo;, настоящим даю
								...
								электронного сообщения по&nbsp;e-mail, предоставленному Клиентом, иных способов связи,
								...
								www.modulkassa.ru.</p>
							<p>2.5. В&nbsp;целях настоящего согласия, следующие определения имеют следующие значения:
								...
								паспортные данные, ФИО, место жительства, дата рождения, номер мобильного/городского
							...
							<p>Условия использования программного обеспечения для ЭВМ &laquo;Автоматизированное рабочее
								место кассира МодульКасса&raquo; установлены Договором-Офертой, акцептуя который Клиент
