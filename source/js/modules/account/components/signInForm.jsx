	...
	return (
		<div className="form">
			...
			<div className="form_buttons">
				<input type="submit" disabled={ props.asyncLoading } onClick={props.testAsync} value="Async" className="button second full"/>
				<input type="submit" onClick={props.testAction} value={'Counter '+props.counter} className="button second full"/>
			</div>
		</div> )
};
